# BlueZoneNet
## An example application implementing Hexagonal Architecture. Port of the original bluezone made in Java by jmgarridopaz [https://github.com/jmgarridopaz/bluezone].

See the original article series: [https://jmgarridopaz.github.io/content/hexagonalarchitecture-ig/intro.html]

![BlueZoneNet: Hexagonal Application Figure](bluezone.png)

__BlueZoneNet__ allows car drivers to pay remotely for parking cars at zones in a city, instead of paying with coins using parking meters.
